...
RUN	tar -xzvf /tmp/gensim-0.12.3.tar.gz -C /home/gensim_user/gensim --strip-components=1 
RUN	cd /home/gensim_user/gensim 
RUN	python3 /home/gensim_user/gensim/setup.py install
